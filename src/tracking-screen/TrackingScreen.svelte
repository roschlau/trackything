...
<div class="actions" class:first-use={$trackersStore.length === 0}>
    {#if $trackersStore.length > 0}
        ...
        <Button linkTo="/reports">
            <img class="action-icon" src="/icons/reports_default.svg" alt="Reports Icon" width="24" height="24"/>
        </Button>
    ...
    {:else}
        <Button on:click={importFromFile}>
            <svg class="action-icon" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
